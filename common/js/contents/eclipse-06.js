(function () {
	...
	*/
	var PARAM = {
		...
		strokeColor:LIB.getRndRGBA(150,0.5,105),
...
//		bgColor:"#222222",
	...
	DAT.add(PARAM, 'bgAlpha',0.005,1.00);
...
//		}
	...
	var drawCircle = function(){
		var _c 				= ctx,
			...
			_opprad = _rad+(Math.PI*Math.random())>>0,
//		var _opprad = _rad*Math.PI,
		...
		_radiusnoise += 0.005;
		_radius = (perlin.noise(_radiusnoise,0)*600 + 100)>>0;
		
//		_c.strokeStyle = LIB.getRndRGBA(255,0.3,0);
		_c.strokeStyle = PARAM.strokeColor;
		_c.fillStyle = PARAM.fillColor;
//		_c.fillStyle = LIB.getRndRGB(100,50);
		
		var _arcRad = Math.random()*10,
			_arcShapeRad = (perlin.noise(_radiusnoise,0)*360>>0)*_radians;
		
//		_c.lineWidth= Math.random()*6>>0;
//		console.log(_radius);
		var _rc = (_radius <= 1 )?1 : _radius;
//		_c.beginPath();
//		_c.arc(_centerX,_centerY,_rc,0,360*_radians,false);
//		_c.closePath();
//		_c.stroke();
...
//		_c.moveTo(_x,_y);
//		_c.lineTo(_x2,_y2);
		_c.arc(_x,_y,_arcRad,0,_arcShapeRad,false);
		_c.closePath();
		_c.fill();
		
//		_c.beginPath();
//		_c.arc(_x2,_y2,_arcRad,0,_arcShapeRad,false);
//		_c.closePath();
//		_c.fill();
//		_c.stroke();
